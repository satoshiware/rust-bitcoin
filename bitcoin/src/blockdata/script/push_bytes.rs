...
mod primitive {
    ...
    // Sizes up to 73 to support all pubkey and signature sizes !!! AZ Money genesis is 91 bytes in length! 75 is the max before a different load bytes opcode is needed.
    from_array! {
